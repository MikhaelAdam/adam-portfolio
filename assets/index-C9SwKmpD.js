...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Wa(e,t,n){return new ni({name:`SphericalGaussianBlur`,defines:{SAMPLES:ka,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:qa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ga(){return new ni({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:qa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ka(){return new ni({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:qa(),fragmentShader:`
	...
	`}var Ja=class extends Ct{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Hr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `,transparent:!0,depthWrite:!1,blending:2});this.points=new Br(d,f)}update(e){this.time+=e,this.points.material.uniforms.uTime.value=this.time}dispose(){this.points.geometry.dispose(),this.points.material.dispose()}},Vc=new ln;Vc.background=new Z(`rgb(37, 37, 37)`),Vc.add(Rc),Rc.position.y+=30,Rc.position.x+=100;var Hc=new Yi(16777215,.5);Vc.add(Hc);var Uc=new Ji(16777215,1);Uc.position.set(1,1,1),Vc.add(Uc);var Wc=new Bc({count:2e3,radius:400,color:16777215});Vc.add(Wc.points);var Gc=Fc();Vc.add(Gc),Gc.position.clone(),Gc.rotation.clone(),Rc.position.clone();var Kc=Gc.zoom,qc=100,Jc=Pc();Jc.render(Vc,Gc);var Yc=new ea;function Xc(){let e=window.scrollY;document.querySelector(`.hero`).classList.toggle(`hero-hidden`,e<qc),Gc.zoom=Kc-e*2e-4,Gc.updateProjectionMatrix()}document.body.onscroll=Xc,Xc(),window.addEventListener(`resize`,()=>{Gc.aspect=window.innerWidth/window.innerHeight,Gc.updateProjectionMatrix(),Jc.setSize(window.innerWidth,window.innerHeight)},!1);function Zc(){requestAnimationFrame(Zc);let e=Yc.getDelta();window.scrollY==0&&(Rc.rotation.y=0),window.scrollY>0&&Rc.rotateY(.002),Wc.update(e),Jc.render(Vc,Gc)}Zc();